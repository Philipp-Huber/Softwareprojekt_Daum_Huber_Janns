...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BooleanWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 30, 0)
    ...
    "BooleanWidget\0editingFinished\0\0"
};
...
void BooleanWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (BooleanWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BooleanWidget::editingFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject BooleanWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BooleanWidget.data,
      qt_meta_data_BooleanWidget,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void BooleanWidget::editingFinished()
{
